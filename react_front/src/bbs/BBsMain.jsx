...
class BBsMain extends Component {
  ...
  */
  ...
  fetchBBsList = () => {
    fetch(BBS_FETCH_URL)
      .then((res) => {
        // console 진행을 하다가 Lock이 걸리는 경우가 있을 때는
        // 주석처리를 해준다.
...
/*
    ...
    부모 >> 자식 으로 일방통행 방식으로 데이터를 전달할 수 있다.
    부모 >> 자식으로 전달된 변수는 자식 입장에서는 모두 props가 된다.
