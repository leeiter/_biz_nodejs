...
/*
    LifeCycle method
    code snippet이 생성하는 method는 16.3 이전에 주로 사용하던 method
    ...
    처음 Component를 생성하고 start를 했을 때
...
class TodoList extends Component {
  ...
  /*
    화면에 리스트를 표현하기 위한 todoList 배열이
    변경이 되었느냐를 판단해서
    render() 함수를 호출할지 안할지를 알려주는 method

    js에서 객체(배열) == 객체(배열) 비교를 할 경우
    간혹 비슷한 주소 위치를 참조하여 서로 내용이 다름에도 같은 배열로
    나타나는 경구가 있다.
